      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="mt-6 text-2xl md:text-4xl font-bold animate-fade-in-up-delay-2 h-14 flex items-center justify-center">
            <TypewriterText
              words={["AI Enthusiast", "Career Strategist", "Tech Writer", "Building the Future"]}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal direction="left">
              ...
              <p className="mt-2 text-lg font-semibold text-[#ff3b30]">AI Enthusiast</p>
            ...
            <ScrollReveal direction="right" delay={0.2}>
              <div className="relative flex justify-center">
                ...
                <div className="relative">
                  <div className="w-72 h-72 md:w-80 md:h-80 rounded-full overflow-hidden shadow-[0_0_60px_rgba(255,59,48,0.3)]">
                  ...
                  {/* Glow behind */}
                  <div className="absolute inset-0 -z-10 rounded-full bg-[#ff3b30]/15 blur-[60px] scale-125" />
                </div>
              </div>
            </ScrollReveal>
          </div>
